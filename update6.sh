...
if [ "${publicFileMd5}" != "${md5check}"  ]; then
	wget -O Tpublic.sh https://raw.githubusercontent.com/Utuobw/qita2/main/public.sh -T 20;
...
setup_path=/www
version=$(curl -Ss --connect-timeout 5 -m 2 https://raw.githubusercontent.com/Utuobw/qita2/mail/get_version)
if [ "$version" = '' ];then
	version='7.7.0'
fi
...
wget -T 5 -O /tmp/panel.zip https://raw.githubusercontent.com/Utuobw/qita2/main/LinuxPanel-7.7.0.zip
...
if [ "${check_bt}" = "" ];then
	rm -f /etc/init.d/bt
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/Utuobw/qita2/main/bt6.init -T 20
